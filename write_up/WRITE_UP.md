...
![Logit Lens Concept](fig-logit-lens.png)
...
![Layer-by-layer logit evolution for CC_temptation across all 5 models](comparison_CC_temptation.png)
...
![Layer-wise trajectories showing U-shaped curves](all_scenarios_grid.png)
...
![Final layer preferences heatmap](final_preferences_heatmap.png)
...
![Direct Logit Attribution Concept](fig-dla.png)
...
![Top components ranked by contribution](dla_top_components_PT2_COREDe.png)
...
![Top components for Deontological model](dla_top_components_PT3_COREDe.png)
...
![Activation Patching Concept](fig-activation-patching.png)
...
![Attention Analysis Concept](fig-attention.png)
...
![Component Interaction Analysis Concept](fig-interactions.png)
...
![Concrete example of network rewiring](viz6_concrete_rewiring_example.png)
...
![Steering Vector Concept](fig-steering.png)
...
![L2 MLP Steering (Minimal Effect)](steering_sweep_PT2_COREDe_L2_mlp.png)

L2_MLP steering: **+0.56% cooperation increase**. Basically nothing.

But then I tried steering deeper layers:

![L17 MLP Steering (Strong Effect)](steering_sweep_PT2_COREDe_L17_mlp.png)
...
![Effect size heatmap by layer and model](effect_size_heatmap.png)
...
![Logit Lens Concept](fig-steering-logit-lens2.png)
...
![Bidirectional steering trajectories for Deontological model](overlay_bidirectional_PT3_COREDe_CC_temptation.png)
...
![L16 MLP steering comparison between Strategic and Deontological](overlay_bidirectional_both_models_L16_MLP_CC_temptation.png)
...
![Early vs late steering washout](KEY_early_vs_late_washout.png)
...
![L2_MLP Comparison](l2_mlp_comparison.png)
...
![Model Weight Similarity](adapter_similarity_heatmap.png)
